...
let arabicStrings: [String: String] = [
    ...
    "A voice made here may be cleared to make room when several families are using the demonstration at once. The recording you add stays on this device.": "قد يُحذف الصوت المُنشأ هنا لإفساح المجال حين تستخدم عدة عائلات العرض في الوقت نفسه. أما التسجيل الذي تضيفه فيبقى على هذا الجهاز.",
    ...
    "That will not be spoken in their voice.": "لن يُقال ذلك بصوتهم.",
    ...
    "Arabic PDFs come out of the file with the letters in the wrong order. Save the text as a .txt file and import that instead.": "تخرج ملفات PDF العربية من الملف وحروفها بترتيب خاطئ. احفظ النص في ملف ‎.txt واستورده بدلا من ذلك.",
    "That PDF could not be opened.": "تعذّر فتح ملف PDF هذا.",
